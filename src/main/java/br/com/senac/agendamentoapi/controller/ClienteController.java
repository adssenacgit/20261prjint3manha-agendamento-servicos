...
import br.com.senac.agendamentoapi.service.ClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<ClienteResponse> atualizar(@PathVariable Integer id, @RequestBody @Valid ClienteRequest request) {
